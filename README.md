...
![Unibox connect buttons](https://cdn.jsdelivr.net/npm/unibox-sdk@latest/assets/image.png)

Oauth 2.0 flow is handled when you hit the auth routes

![Unibox OAuth flow](https://cdn.jsdelivr.net/npm/unibox-sdk@latest/assets/image-1.png)
...
![Unread emails (enriched view)](https://cdn.jsdelivr.net/npm/unibox-sdk@latest/assets/image-2.png)

version : plane without colors, dates, or permalinks (good for testing)

![Unread emails (plain view)](https://cdn.jsdelivr.net/npm/unibox-sdk@latest/assets/image-3.png)
